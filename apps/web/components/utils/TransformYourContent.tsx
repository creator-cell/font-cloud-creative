...
import { ArrowRight, TrendingUp, Zap, CheckCircle, Sparkles } from "lucide-react";
...
const TransformYourContent = () => {
  ...
  return (
    <motion.section
      {...fadeIn()}
      className="relative bg-gradient-to-r from-[#0072ff] via-[#0099ff] to-[#00c6ff] text-white rounded-2xl py-14 px-6 md:px-8 my-10 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        {/* Left Section */}
        <div>
          <h2 className="text-3xl md:text-[2.5rem] font-bold leading-tight mb-3">
            Ready to Transform Your <br className="hidden md:block" /> Content Creation?
          </h2>
          <p className="text-white/90 mb-4 max-w-md">
            Join thousands of creators who have already revolutionized their workflow with Front Cloud Creative.
          </p>
          ...
          <Button className="bg-white text-sky-400 font-semibold hover:bg-white/90 transition rounded-lg px-5 py-3">
