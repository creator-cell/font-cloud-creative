        ...
        <div className="mx-auto flex w-full flex-wrap items-center justify-between gap-4 px-6 py-4 text-sm text-slate-600 md:px-10 lg:px-16 xl:px-24">
          <Link href="/" className="flex items-center gap-3 text-base font-semibold text-slate-900">
            <Image
              ...
              className="h-12 w-auto" // Adjusted height class for better scaling
              priority
            />
      ...
      <main className="relative mx-auto flex w-full flex-col gap-24 px-6 pb-0 pt-32 md:px-10 lg:px-16 xl:px-24">
        ...
        <section className="space-y-10" id="solutions">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {speedFeatures.map(({ title, description, Icon }) => (
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          {orchestrateCards.map(({ badge, title, description, bullets, Icon }) => (
            <Card
              key={title}
        ...
        <section className="space-y-10" id="resources">
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {creationFeatures.map(({ title, description, Icon }) => (
              <div key={title} className="rounded-3xl border border-sky-100 bg-white p-6 shadow-sm">
                <span className="flex h-12 w-12 items-center justify-center rounded-full bg-sky-100 text-sky-600">
                  <Icon className="h-5 w-5" />
                </span>
          ...
          <Card className="rounded-3xl border border-white bg-gradient-to-br  p-6  dark:border-transparent dark:bg-gradient-to-br dark:from-sky-300/60 dark:via-white dark:to-sky-200/60 ">
            ...
            <CardContent className="space-y-4 text-slate-900">
              <div className="flex flex-wrap gap-3">
                {copy.newsroomActions.map((action) => (
                  <span
                    key={action}
        ...
        <section className="space-y-10" id="pricing">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {copy.pricingPlans.map((plan) => (
              <Card
                key={plan.id}
                className={`border bg-white p-6 text-black shadow-lg transition hover:-translate-y-1 dark:border-sky-100 dark:bg-white dark:text-black ${
